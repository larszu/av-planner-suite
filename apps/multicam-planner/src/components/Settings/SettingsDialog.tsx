...
// jede Regel aus dem Stilblatt — ein lokaler Schalter koennte die Farben
// also gar nicht aendern, und die naechste Theme-Nachricht der Shell setzte
// ihn ohnehin zurueck. Ihn trotzdem zu zeigen waere derselbe Fehler, den der
// Absatz darueber beschreibt: ein Bedienelement, das aussieht wie eine
// Faehigkeit. Standalone (Web-Seite, Electron) gibt es keine Shell, dort ist
// er da. Das ist die einzige Stelle, an der diese Kopie vom Upstream
// abweicht — deshalb steht sie hier und nicht in einem Overlay-Modul.
//
