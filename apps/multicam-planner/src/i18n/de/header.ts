...
export const header: Record<string, string> = {
  ...
  'header.open.desc': 'Gespeichertes MultiCam-Projekt laden',
  // Gebündelte Import-/Export-Menüs
  'header.importMenu': 'Import',
  'header.importMenu.title': 'Projekt- oder Venue-Datei importieren',
  'header.exportMenu.title': 'Dateien oder Kamera-Ansichten exportieren',
  'header.export.filesSection': 'Dateien',
  'header.export.imagesSection': 'Bilder (PNG)',
  'header.avplanExport': 'Gesamtprojekt',
  'header.avplanExport.desc': 'Venue + Kameras + Licht + Verkabelung — verlustfrei über alle drei Apps',
  'header.avplanImport': 'Kombiniertes Projekt',
  'header.avplanImport.desc': 'Kameras werden nativ geladen; Licht & Verkabelung bleiben erhalten',
  'header.venueExport': 'Venue',
  'header.venueExport.desc': 'Raum, Wände, Bühne & Personen — geteilt mit dem Light-Planner',
  'header.venueImport': 'Venue',
  'header.venueImport.desc': 'Ersetzt Raum, Wände, Bühne & Personen; Kameras bleiben erhalten',
  'header.camerasExport': 'Kameras → Cable-Planner',
  'header.camerasExport.desc': 'Platzierte Kameras werden zu Verkabelungs-Knoten',
  'header.avplanExport.title': 'Vollständiges kombiniertes Projekt exportieren (.avplan) — Venue + Kameras + Licht + Verkabelung, verlustfrei über alle drei Apps',
  'header.avplanImport.title': 'Kombiniertes Projekt importieren (.avplan) — Kameras werden nativ geladen, Licht/Verkabelung verlustfrei erhalten',
  'header.lamps': 'Lampen',
  'header.lamps.title': 'Nur-Lese-Lichtgeräte aus dem Light-Planner (.avplan) ein-/ausblenden',
  'header.venueExport.title': 'Venue (Raum, Wände, Bühne, Personen, Grundriss) als geteilte .venue.json exportieren — im Light-Planner importierbar',
  'header.venueImport.title': 'Geteilte Venue (.venue.json) importieren — ersetzt Raum, Wände, Bühne, Personen, Grundriss; Kameras bleiben erhalten',
  'header.camerasExport.title': 'Platzierte Kameras als .cameras.json für den Cable-Planner exportieren — dort werden sie zu Verkabelungs-Equipment-Knoten',
