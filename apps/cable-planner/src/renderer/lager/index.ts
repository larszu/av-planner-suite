...
// OVERLAY (Suite): wie oben — die Typen kommen aus dem Paket.
export type { InventoryItem, InventoryUnit, StorageNode, InventoryOwnership } from '@avplan/inventory-core'
