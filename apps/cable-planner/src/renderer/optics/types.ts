// Optik-Modul aus multicam-planner übernommen. SourceIdentity wird hier nicht
// gebraucht (nur an einem fremden Feld) — lokal auf unknown gesetzt.
type SourceIdentity = unknown;
