...
export const en: Dict = {
  ...
  'doclog.entries': 'entries for this project',
  'doclog.empty': 'Nothing has been handed out for this project yet — or the exports came from another machine.',
  'doclog.col.doc': 'Document',
  'doclog.col.since': 'What changed since',
  'doclog.noRecipient': 'Recipient not named',
  'doclog.stale': 'superseded',
  'doclog.allCurrent': 'all current',
  'doclog.withDiff': 'with a comparison',
  'doclog.since.rev': 'against',
  'doclog.since.noRevision': 'The version of that time was never committed - only that the sheet is superseded.',
  'doclog.since.notReproducible': "This document's stand cannot be recomputed from the plan alone.",
  'doclog.col.when': 'Handed out',
  'doclog.col.stand': 'Revision on the sheet',
  'doclog.col.status': 'Still valid?',
  'doclog.superseded': 'superseded — hand out again',
  'doclog.unknown': 'cannot tell',
  'doclog.current': 'current',
  'doclog.clear': 'Clear register',
  'doclog.clear.confirm': 'Clear the register?',
  'doclog.clear.body': 'The list of documents handed out will be deleted — including other projects. The printouts themselves are not affected.',
  'doclog.dropped': 'Older entries have fallen out of the register:',
  'doclog.otherProjects': 'Further entries belong to other projects:',
  'app.menu.file.documentLog': 'Documents handed out…',
  'prov.unknown': 'unconfirmed',
  'prov.commanded': 'sent',
  'prov.confirmed': 'confirmed',
  'cred.title': 'Include credentials?',
  'cred.body.one': 'One entry carries a device username or password.',
  'cred.body.many': '{n} entries carry a device username or password.',
  'cred.include': 'Include',
  ...
  'avplan.unknown.assign': 'Take over as',
  'avplan.unknown.discard': 'Discard',
  'avplan.unknown.noTargets': 'No known section is free — taking over is therefore not offered.',
  'avplan.unknown.keepAll': 'Carry all through',
  'compare.title': 'Compare plan revisions',
  'compare.pick': 'Choose comparison file…',
  'compare.hint': 'Pick a second project file — for example the revision a colleague sent back — or a committed revision from this project. Either is only read, never opened.',
  'compare.orRevision': 'or committed revision:',
  'compare.chooseRevision': '— choose —',
  'compare.fromRevision': 'Earlier revision: revision',
  'compare.fromFile': 'Earlier revision: file',
  'compare.error.notAPlan': 'This file does not contain a readable plan (equipment and cable lists are missing).',
  'compare.footer': 'The open plan counts as the newer revision. Nothing is loaded or overwritten.',
  'compare.exportCsv': 'Export as CSV',
  'compare.standBefore': 'Revision of the chosen file',
  'compare.standBeforeRevision': 'Revision of the chosen commit',
  'compare.standAfter': 'Revision of the open plan',
  'compare.documents': 'Documents',
  'compare.verdict.invalidated': 'superseded',
  'compare.verdict.unknown': 'cannot tell',
  'compare.verdict.unaffected': 'unchanged',
  'compare.changes': 'Differences',
  'compare.noEntities': 'No differences in equipment or cables.',
  'compare.change.removed': 'gone',
  'compare.change.added': 'new',
  'compare.change.modified': 'changed',
  'compare.sensitiveChanged': 'changed (credentials are not shown)',
  'compare.unclassifiedChanged': 'changed (unknown field)',
  'compare.sections': 'Other project areas (not itemised)',
  'compare.recreationHint': 'Same name in both the removed and the added list — probably re-created rather than edited. This comparison cannot tell them apart:',
  'compare.unclassified': 'Fields without a classification — reported as changed, but without values:',
  ...
  // Bedarf 76 — die Suche antwortet, statt nur zu springen.
  'canvas.search.depends': '{n} attached: {liste}',
  'canvas.search.f.name': 'Name',
  'canvas.search.f.shortName': 'Short name',
  'canvas.search.f.ip': 'IP',
  'canvas.search.f.mac': 'MAC',
  'canvas.search.f.vlan': 'VLAN',
  'canvas.search.f.assetTag': 'Asset no.',
  'canvas.search.f.serial': 'Serial number',
  'canvas.search.f.qrId': 'Label code',
  'canvas.search.f.switchPort': 'Switch port',
  'canvas.search.f.category': 'Category',
  'canvas.search.f.subtitle': 'Subtitle',
  'canvas.search.f.notes': 'Note',
  ...
  'panel.window.button': 'Window',
  'panel.window.title': 'undock, drag out or move to its own window',
  'panel.window.undock': 'Undock (floating)',
  'panel.window.popout': 'Open in its own window',
  'panel.window.dragHint': 'The button can also be dragged.',
  ...
  'canvas.layerChips.menuButton': 'Layers',
  ...
  'analysis.crew.from': 'from',
  'analysis.crew.to': 'to',
  'analysis.crew.csv': 'Sheet as CSV',
  'analysis.crew.hours': 'Hours',
  'analysis.crew.labour': 'Labour',
  'analysis.crew.expensesBillable': 'Billable expenses',
  'analysis.crew.expensesOwn': 'own expenses',
  'analysis.crew.billable': 'to the client',
  'analysis.crew.unpriced': '{n} shift(s) without a rate — not in any total',
  'analysis.crew.people': 'People',
  'analysis.crew.removePerson': 'Remove person with their rates and shifts',
  'analysis.crew.bands': 'Surcharge bands',
  'analysis.crew.removeBand': 'Remove band',
  'analysis.crew.rates': 'Rates',
  'analysis.crew.activity': 'Activity',
  'analysis.crew.hourly': 'Hourly rate',
  'analysis.crew.calloutPh': 'Call-out',
  'analysis.crew.callout': 'Call-out fee',
  'analysis.crew.otAfterPh': 'after h',
  'analysis.crew.otAfter': 'Overtime after hours',
  'analysis.crew.otPercentPh': '+ %',
  'analysis.crew.otPercent': 'Overtime surcharge',
  'analysis.crew.removeRate': 'Remove rate with its shifts',
  'analysis.crew.entries': 'Shifts',
  'analysis.crew.date': 'Date',
  'analysis.crew.rate': 'Rate',
  'analysis.crew.start': 'Start',
  'analysis.crew.end': 'End',
  'analysis.crew.nextDay': 'next day',
  'analysis.crew.ot': 'overtime',
  'analysis.crew.removeEntry': 'Remove shift',
  'analysis.crew.addEntry': 'Shift',
  'analysis.crew.expenses': 'Expenses',
  'analysis.crew.noReceipt': 'no receipt',
  'analysis.crew.billableYes': 'goes to the client',
  'analysis.crew.billableNo': 'own cost',
  'analysis.crew.removeExpense': 'Remove expense',
  'analysis.crew.approvals': 'Approvals',
  'analysis.crew.approvalHint':
    'Paste the message — time and sender are read from the text, as far as they are in it. If it carries no time, the approval gets none: an invented date is exactly the line the money hangs on in a dispute.',
  'analysis.crew.pastePh': '[09/09/26, 20:14] Max Mustermann: yes, do the overtime',
  'analysis.crew.paste': 'Paste message',
  'analysis.crew.scope': 'What the approval covers',
  'analysis.crew.scopeFree': '— general —',
  'analysis.crew.scopeOvertime': 'Overtime',
  'analysis.crew.addApproval': 'Record approval',
  'analysis.crew.noGivenAt': 'time not stated',
  'analysis.crew.removeApproval': 'Remove approval',
  'analysis.crew.handoff': 'Handover to the accounts (net)',
  'analysis.crew.namePh': 'Name',
  'analysis.crew.name': 'Name',
  'analysis.crew.companyPh': 'Company / freelance',
  'analysis.crew.company': 'Company',
  'analysis.crew.addPerson': 'Person',
  'analysis.crew.bandPh': 'Band name, e.g. Night',
  'analysis.crew.bandName': 'Band name',
  'analysis.crew.bandFrom': 'Band from',
  'analysis.crew.bandTo': 'Band to',
  'analysis.crew.bandPercent': 'Surcharge in percent',
  'analysis.crew.sundayOnly': 'Sundays only',
  'analysis.crew.addBand': 'Band',
  'analysis.crew.person': 'Person',
  'analysis.crew.activityPh': 'Activity',
  'analysis.crew.hourlyPh': 'Hourly rate',
  'analysis.crew.addRate': 'Rate',
  'analysis.crew.expenseDate': 'Date of the expense',
  'analysis.crew.expenseKind': 'Kind of expense',
  'analysis.crew.expensePerson': 'Who paid',
  'analysis.crew.expenseNoPerson': '— Job —',
  'analysis.crew.amountPh': 'Amount',
  'analysis.crew.amount': 'Amount',
  ...
  // Bedarf 97 — Beleg an der Auslagenzeile.
  'analysis.crew.receiptHint':
    'The receipt hangs on the line, not on the project: only that way is it visible which slip belongs to which amount. The file lives in the folder "Belege" next to the project — pass the project on without that folder and the receipts do not travel with it. The cost line next to it decides whether the expense shows up in the cost comparison at all.',
  'analysis.crew.expenseCostLine': 'Cost line for this expense',
  'analysis.crew.expenseNoCostLine': '— no cost line —',
  'analysis.crew.coverage': 'Receipt coverage per cost line',
  'analysis.crew.coverageHint':
    'The documented sum is not written into the actual. It stands beside it so the difference is visible — it is taken over only on click, and then it carries "from the invoice" as its source.',
  'analysis.crew.documented': 'documented',
  'analysis.crew.withFile': 'of which with a file',
  'analysis.crew.actual': 'Actual',
  'analysis.crew.actualUnset': 'not set',
  'analysis.crew.takeActual': 'Take as actual',
  'analysis.crew.unlinkedCount': '{n} expenses point at no cost line and show up in no comparison.',
  'analysis.crew.receiptDesktopOnly': 'Receipt files only in the desktop app',
  'analysis.crew.attachReceipt': 'Attach receipt',
  'analysis.crew.revealReceipt': 'Show in folder',
  'analysis.crew.detachReceipt': 'Detach receipt',
  'analysis.crew.pasteReceipt': 'Paste receipt text (till-slip mail, PDF text, typed)',
  'analysis.crew.readDate': 'Date',
  'analysis.crew.readAmount': 'Amount',
  'analysis.crew.readMerchant': 'Merchant',
  'analysis.crew.readCurrency': 'Currency',
  'analysis.crew.readVat': 'Tax rate',
  'analysis.crew.readNothing': 'not read',
  'analysis.crew.pickAmount': 'Which amount is the total?',
  ...
  'switching.companionFetch': 'Fetch connections',
  'switching.companionLoading': 'asking \u2026',
  'switching.companionFound': 'Configured in this Companion:',
  'switching.companionNote': 'note',
  'switching.companionOff': ', off',
  'switching.companionEmpty': 'Companion answers, but has no connection configured.',
  'switching.companionPage': 'Page',
  'switching.companionRow': 'Row',
  'switching.companionColumn': 'Column',
  'switching.companionVarOut': 'Output variable',
  'switching.companionVarIn': 'Input variable',
  'switching.companionNoted': 'Noted:',
  ...
  // Bedarf 20 — schichtbare Adressbereiche: stehender Plan + Haus-Ebene.
  'addrTpl.title': 'Address ranges (standing plan + venue overlay)',
  'addrTpl.hint':
  ...
  'addrTpl.layer.standing': 'standing plan',
  'addrTpl.layer.venue': 'venue',
  'addrTpl.kind.container': 'container',
  'addrTpl.kind.assignable': 'assignable',
  'addrTpl.addStanding': 'standing layer',
  'addrTpl.addVenue': 'venue layer',
  'addrTpl.newStanding': 'Truck',
  'addrTpl.newVenue': 'Venue',
  'addrTpl.export': 'Ranges',
  'addrTpl.empty': 'No layer created yet.',
  'addrTpl.noRanges': 'No range in this layer yet.',
  'addrTpl.layerNamePh': 'OB truck 2',
  'addrTpl.newRangePh': '10.2.0.0/16',
  'addrTpl.addRange': 'Range',
  'addrTpl.removeLayer': 'Remove layer',
  'addrTpl.removeRange': 'Remove range',
  'addrTpl.keyPh': 'control',
  'addrTpl.namePh': 'Control',
  'addrTpl.col.key': 'Key',
  'addrTpl.col.name': 'Range',
  'addrTpl.col.cidr': 'CIDR',
  'addrTpl.col.kind': 'Kind',
  'addrTpl.col.role': 'Purpose',
  'addrTpl.col.vlan': 'VLAN',
  'addrTpl.resolved': 'What is in force after the overlay',
  'addrTpl.replaces': 'replaces {name} ({cidr})',
  'addrTpl.proposals': 'Re-address proposals (adopt one at a time)',
  'addrTpl.apply': 'adopt',
  'addrTpl.refusal.no-address': 'no address recorded',
  'addrTpl.refusal.no-range': 'no range planned for this purpose',
  'addrTpl.refusal.already-inside': 'already inside the planned range',
  'addrTpl.refusal.host-does-not-fit': 'the host part does not fit the target range',
  'addrTpl.refusal.network-or-broadcast':
    'would be the network or broadcast address of the target range',
  'addrTpl.refusal.already-taken': 'the proposed address already belongs to another device',
  ...
  'tallyPos.export': 'Pre-show list',
  'tallyPos.record': 'seen',
  'tallyPos.count': '{checked} of {total} positions checked.',
  'tallyPos.col.role': 'Position',
  'tallyPos.col.transport': 'Path',
  'tallyPos.col.endpoint': 'Address',
  'tallyPos.col.lamp': 'Lamp',
  'tallyPos.col.program': 'Program',
  'tallyPos.col.preview': 'Preview',
  'tallyPos.col.verdict': 'Last',
  'tallyPos.endpointPh': 'IP / pin / source',
  'tallyPos.lampPh': 'camera head',
  'tallyPos.transport.tsl-umd-v31': 'TSL UMD v3.1',
  'tallyPos.transport.gpio': 'GPIO / contact',
  'tallyPos.transport.ndi': 'NDI metadata',
  'tallyPos.transport.switcher-native': 'switcher itself',
  'tallyPos.transport.unknown': 'not decided',
  'tallyPos.obs.red': 'red',
  'tallyPos.obs.green': 'green',
  'tallyPos.obs.off': 'off',
  'tallyPos.obs.blinking': 'blinking',
  'tallyPos.obs.wrong-colour': 'wrong colour',
  'tallyPos.obs.wrong-position': 'wrong position',
  'tallyPos.obs.not-checked': 'not checked',
  'tallyPos.verdict.verified': 'seen and correct',
  'tallyPos.verdict.lying': 'shows something wrong',
  'tallyPos.verdict.dark': 'stays dark',
  'tallyPos.verdict.unchecked': 'not checked',
  ...
  'hotkeys.action.selectAll': 'Select all',
  ...
  'app.menu.file.planCompare': 'Compare plan revisions…',
  ...
  'app.menu.tools.analysis.note': 'Weight, network, redundancy, cable runs',
  'app.menu.tools.planCheck.note': 'Finds gaps and contradictions in the plan',
  'app.menu.tools.reconcile.note': 'Compares the plan with what is on site',
  'app.menu.tools.drumMicing.note': 'Place and name microphones on the kit',
  'app.menu.tools.wirelessRig.note': 'Frequencies, transmitters, receivers in the spectrum',
  'app.menu.tools.delivery.note': 'Where it goes out, with which parameters',
  'app.menu.tools.rackBuilder.note': 'Populate and edit existing racks',
  'app.menu.tools.aiPlanGen.note': 'Generates a draft from a description',
  'app.menu.tools.patchList.note': 'Who sits on which input and output',
  'app.menu.tools.stagePlot.note': 'Stage top view as a one-page sheet',
  'app.menu.tools.bulkConnect.note': 'Cable many ports in one go',
  'app.menu.tools.revisions.note': 'Save and compare states',
  ...
  // Bedarf 88 — die Angaben zur Veranstaltung, einmal getippt.
  'delivery.event.title': 'Event details',
  'delivery.event.titleLabel': 'Title',
  'delivery.event.titlePh': 'Event title',
  'delivery.event.desc': 'Description',
  'delivery.event.descPh': 'Description text for the platform forms',
  'delivery.event.start': 'Scheduled start',
  'delivery.event.startPh': 'Start, e.g. 2026-09-12T19:00+02:00',
  'delivery.event.tz': 'Time zone',
  'delivery.event.tzPh': 'Announced in, e.g. Europe/Berlin',
  'delivery.event.privacy': 'Visibility',
  'delivery.event.privacy.notStated': '\u2014 visibility not stated \u2014',
  'delivery.event.privacy.public': 'public',
  'delivery.event.privacy.unlisted': 'unlisted',
  'delivery.event.privacy.private': 'private',
  'delivery.event.thumb': 'Thumbnail',
  'delivery.event.thumbPh': 'Thumbnail \u2014 file name, not the image',
  'delivery.event.tags': 'Tags',
  'delivery.event.tagsPh': 'Tags, comma separated',
  'delivery.event.overrides':
    'Deliberate deviations per destination \u2014 empty means \u201csame as the project\u201d.',
  'delivery.event.ovTitle': 'Deviating title',
  'delivery.event.ovTitlePh': 'deviating title',
  'delivery.event.ovReason': 'Reason',
  'delivery.event.ovReasonPh': 'why deviating?',
  ...
  'shortcutsHelp.panels': 'Panels & view',
  'shortcutsHelp.toggleLibrary': 'Show/hide library',
  'shortcutsHelp.toggleProperties': 'Show/hide properties',
  'shortcutsHelp.jumpToPatches': 'Open patch list',
  'shortcutsHelp.toggleArrows': 'Toggle arrow display',
  ...
  // Adressplan (Initiative 8) — der aus den Geraete-Datensaetzen abgeleitete
  // Teil der Netz-Ansicht: was fehlt und was nicht stimmt.
  'analysis.address.title': 'Address plan',
  ...
  'analysis.address.missing': 'No address',
  'analysis.address.duplicate': 'Address used twice',
  'analysis.address.noMask': 'No mask (/24 assumed)',
  'analysis.address.gatewayOutside': 'Gateway outside the subnet',
  'analysis.address.netOrBroadcast': 'Network or broadcast address',
  ...
  // Bedarf 79 — Kosten: Plan gegen Ist.
  'analysis.tab.cost': 'Cost: plan vs actual',
  'analysis.cost.currency': 'Currency',
  'analysis.cost.currencyPh': 'Currency, e.g. EUR',
  'analysis.cost.tolerance': 'Tolerance',
  'analysis.cost.tolerancePh': 'Tolerance in %',
  'analysis.cost.add': 'Line',
  'analysis.cost.label': 'Label',
  'analysis.cost.labelPh': 'Line',
  'analysis.cost.anchor': 'Anchor in the plan',
  'analysis.cost.free': '\u2014 no anchor \u2014',
  'analysis.cost.estimate': 'Estimate',
  'analysis.cost.estimatePh': 'Estimate',
  'analysis.cost.actual': 'Actual',
  'analysis.cost.actualPh': 'Actual',
  'analysis.cost.source': 'Origin of the actual',
  'analysis.cost.unknown': 'unknown',
  'analysis.cost.remove': 'Remove line',
  ...
  'settings.customPalette.desc': 'Custom colors for canvas background and grid — overrides the theme defaults (dark/light). Affects only the canvas; dialogs stay themed.',
  ...
  // ── SUITE-OVERLAY: Lexware-Integration ───────────────────────────────────
  //
  // Diese 15 Schluessel gibt es nur in der Suite-Kopie — `IntegrationsTab.tsx`
  // traegt hier 131 Zeilen mehr als upstream (Drift-Bericht, suite-ahead).
  // Der vendorierte Guard aus `cable#671` hat sie beim ERSTEN Lauf in dieser
  // Kopie gemeldet: erreichbar, aber ohne englische Fassung.
  //
  // Damit weicht diese Datei bewusst um 15 Zeilen von upstream ab. Wandert
  // der Lexware-Tab eines Tages nach upstream, gehen sie mit.
  ...
  'settings.integrations.lexware.keyPlaceholder': 'Paste API key',
  'settings.integrations.lexware.keyStored': 'Key stored:',
  'settings.integrations.lexware.status': 'Status:',
  'settings.integrations.lexware.statusLoaded': 'Key on file',
  'settings.integrations.lexware.statusNone': 'No key on file',
  'settings.integrations.lexware.statusSaved': 'Key stored securely.',
  'settings.integrations.lexware.save': 'Save',
  'settings.integrations.lexware.saveFailed': 'Could not store the key',
  'settings.integrations.lexware.test': 'Test connection',
  'settings.integrations.lexware.testOk': 'Connection ok',
  ...
  //
  // Drum-Mikrofonierung, Schema-Builder, .avplan-Import/-Export und die
  // Quellen-Karte sind nach jener Sammelrunde dazugekommen und hatten
  // deshalb nie eine. Ohne sie faellt `translate()` auf den deutschen
  // Fallback zurueck — auch fuer `lang === 'en'`.

  // Datei- und Werkzeug-Menue
  'app.menu.file.exportAvplan': 'Export whole project (.avplan)…',
  'app.menu.file.importAvplan': 'Import whole project (.avplan)…',
  'app.menu.file.importAvplanError': 'Import failed — not a valid .avplan file.',
  'app.menu.file.importCameras': 'Import MultiCam cameras…',
  'app.menu.file.importCamerasDone': 'MultiCam camera(s) imported as equipment.',
  'app.menu.file.importCamerasError': 'Camera import failed — not a valid MultiCam camera list.',
  'app.menu.file.viewForeign': 'View linked venue plan…',
  'app.menu.file.viewForeignRoom': 'Room',
  'app.menu.file.viewForeignTitle': 'Linked venue plan (view only)',
  'app.menu.tools.drumMicing': 'Drum micing…',

  // Drum-Mikrofonierung
  'drum.title': 'Drum micing',
  'drum.hint': 'Click a zone → assign a microphone on the right. The presets at the top set a starting point.',
  'drum.addMic': 'Mic',
  'drum.addZone': 'Zone',
  'drum.pickMic': '— pick microphone —',
  'drum.noMic': 'No microphone on this zone yet.',
  'drum.selectZone': 'Click a zone in the kit.',
  'drum.emptyList': 'No microphones placed yet.',
  'drum.pending': '(mic open)',
  'drum.unknown': 'no mic',
  'drum.clear': 'Remove all mics',
  'drum.editKit': 'Edit kit',
  'drum.editDone': 'Kit done',
  'drum.kitEdit': 'Assemble kit',
  'drum.kitEditHint': 'Drag the zones in the image to move them. Add, rename or delete them below.',
  'drum.technique': 'Technique',
  'drum.channels': 'Channels',
  'drum.summary': 'Channel list & requirements',
  'drum.bom': 'Bill of materials',
  'drum.phantom': '48V phantom required',
  'drum.spl': 'SPL borderline',
  ...
  'schemaBuilder.desc': 'Create your own domain fields (e.g. pickup pattern) and categories. They appear automatically in the device properties and in BOM/export. Built-in fields are locked.',
  'schemaBuilder.category': 'Category',
  'schemaBuilder.addCat': 'Create category',
  'schemaBuilder.newCatDe': 'New category (DE)',
  'schemaBuilder.newCatEn': 'Name (EN)',
  'schemaBuilder.empty': 'This category has no fields yet. Create the first one below.',
  'schemaBuilder.newField': 'New field',
  'schemaBuilder.addField': 'Add field',
  'schemaBuilder.key': 'Key',
  'schemaBuilder.labelDe': 'Label (DE)',
  'schemaBuilder.labelEn': 'Label (EN)',
  'schemaBuilder.type': 'Type',
  'schemaBuilder.unit': 'Unit (optional)',
  'schemaBuilder.placeholder': 'Placeholder (optional)',
  'schemaBuilder.options': 'Choice options',
  'schemaBuilder.addOption': 'Option',
  'schemaBuilder.save': 'Create field',
  'schemaBuilder.err.key': 'Please enter a field name.',
  'schemaBuilder.err.dupe': 'This key already exists in the category.',
  'schemaBuilder.err.opts': 'Choice fields need at least one option.',
  ...
  // ── 451 englische Fassungen, die im DEUTSCHEN Woerterbuch standen ────────
  //
  // Sie kamen als Block unter der Marke „i18n coverage completion
  // (auto-merged)" ans Ende des `de`-Dicts. Der Inhalt ist Englisch —
  // „(empty)", „Click = show text", „Configure Videohub · Labels + Routing".
  //
  // Damit waren BEIDE Sprachen falsch, aus einer einzigen Fehlablage:
  //   * Deutsch: `translate('de', k, fallback)` fand den Schluessel im
  //     de-Dict und lieferte den englischen Wert — der deutsche Inline-
  //     Fallback an der Aufrufstelle kam nie zum Zug.
  //   * Englisch: der Schluessel fehlte im en-Dict, also griff der Fallback —
  //     also Deutsch.
  //
  // Die Reparatur ist ein Umzug, keine Uebersetzung: derselbe Text, richtig
  // abgelegt. Der deutsche Text steht weiterhin als Fallback an der
  // Aufrufstelle, wo er hingehoert.
  ...
  'library.origin.ai': 'AI suggestion from name and category — not from a datasheet',
  ...
  'atem.audio.live.adoptBody': 'The plan adopts {n} differing assignments from the switcher. Afterwards the plan states what the device is currently doing — the previous intent is replaced.',
  'atem.audio.live.adoptOk': 'Adopt',
  'atem.audio.live.discard': 'Discard reading',
  'atem.audio.live.discardTitle': 'Discard the reading — the plan stays as it is.',
  ...
  'atem.mv.status.loaded': 'Read from ATEM: {mv} MV, {windows} windows.',
  'atem.mv.live.title': 'Read from the switcher',
  'atem.mv.live.differs': '{n} windows differ from the plan',
  'atem.mv.live.matches': 'Plan and device agree',
  'atem.mv.live.adopt': 'Adopt into the plan',
  'atem.mv.live.adoptTitle': 'Adopt the reading as the new plan — this replaces the previous intent.',
  'atem.mv.live.adoptConfirm': 'Adopt the reading? {changed} of {total} window assignments differ. Afterwards the plan states what the switcher is currently doing.',
  'atem.mv.live.adoptOk': 'Adopt',
  'atem.mv.live.adopted': 'Reading adopted into the plan.',
  'atem.mv.live.discard': 'Discard reading',
  'atem.mv.live.discardTitle': 'Discard the reading — the plan stays as it is.',
  'atem.mv.live.notPlanned': 'not planned',
  'atem.mv.live.notReported': 'not reported',
  ...
  'docs.recipient': 'Recipient of this sheet (department or person)',
  // Bedarf 10 — Ablauf und Kamera-Auftraege.
  'app.menu.tools.rundown': 'Rundown and camera assignments…',
  'app.menu.tools.rundown.note': 'Read in segments, assign a shot per camera position',
  'rundown.title': 'Rundown and camera assignments',
  'rundown.import': 'Read in the rundown',
  'rundown.import.hint': 'The rundown belongs to the editorial team and is only read here. One line per segment: number, title, note - separated by a tab or a semicolon. Cells copied from a spreadsheet bring the tab along.',
  'rundown.source': 'Where it comes from',
  'rundown.source.placeholder': 'e.g. rundown.xlsx, mail of 9 Sept',
  'rundown.sourceUnknown': 'Origin unknown',
  'rundown.revision': 'Version of the source',
  'rundown.revision.placeholder': 'e.g. v4, third draft',
  'rundown.read': 'Read in',
  'rundown.segments': 'segments',
  'rundown.finding.line': 'Line',
  'rundown.finding.noTitle': 'number without a title - not taken over',
  'rundown.finding.empty': 'nothing readable - not taken over',
  'rundown.noIdentities': 'There are no source roles ("Camera 1") yet. Without them there is no position an assignment could belong to.',
  'rundown.coverage': 'Who does what',
  'rundown.coverage.hint': 'The assignment belongs to the role, not to the device - when the standby camera steps in, it stays. An empty cell means "no assignment recorded", not "free".',
  'rundown.col.no': 'No.',
  'rundown.col.title': 'Segment',
  'docs.recipient.placeholder': 'e.g. Camera, Audio, Stage - leaving it empty is fine',
