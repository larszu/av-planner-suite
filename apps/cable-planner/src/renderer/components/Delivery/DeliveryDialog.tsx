        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {list.length > 0 && (
            <div className="mb-4 rounded border border-cp-border-muted bg-cp-surface-2 p-2.5">
              ...
              {/* PanelHint statt blankem <p>: der Satz ist laenger als 140
                  Zeichen, und `tests/hinweisLaenge.test.ts` haelt fest, dass
                  solche Erklaersaetze aufklappbar sind statt dauerhaft die
                  Flaeche zu belegen. Vorher fiel er nicht auf, weil die
                  deutsche Fassung kuerzer war — die Sprachdrehung hat ihn
                  ausgeloest. */}
              <PanelHint
