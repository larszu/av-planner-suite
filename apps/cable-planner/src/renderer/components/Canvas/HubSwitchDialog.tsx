    ...
    >
      ...
      >
        ...
        */}
        {nurPruefstand ? (
          <PanelHint
            className="mb-3 border border-cp-accent/50 bg-cp-accent/10 p-2 text-cp-xs text-cp-text-secondary"
            text={t(
          ...
          <PanelHint
            className="mb-3 border border-cp-danger/50 bg-cp-danger/10 p-2 text-cp-xs text-cp-text-secondary"
            text={
              t(
        ...
        <div className="mt-3 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="av-focus border border-cp-border px-3 py-1 text-cp-xs hover:bg-cp-surface-3"
          >
          ...
          <button
            ...
            onClick={schalten}
            className="av-focus border border-cp-danger px-3 py-1 text-cp-xs text-cp-danger disabled:opacity-40"
          >
            {laeuft
