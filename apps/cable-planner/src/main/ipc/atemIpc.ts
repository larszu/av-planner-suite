...
// UEBERLAGERUNG der Suite: die Kopie baut gegen eine Aufloesung, in der
// `Service` kein Typ-Export ist. Upstream hat die uebrigen Importe mit S-2
// verschmaelert (die Verbindung liegt jetzt in `services/atemSession.ts`) —
// das ist uebernommen, die Ueberlagerung bleibt.
