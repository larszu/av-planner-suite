 ...
 *
 * Drei Saetze, und alle drei sagen dasselbe aus einer anderen Lage: der Sprung
 * ist angekommen, der Planer kennt das Objekt nicht, oder es war gar kein
 * Planer da, den man haette fragen koennen. Ein stummer Sprung sieht aus wie
 * ein gelungener — deshalb hat jede Lage ihren eigenen Satz.
 */
