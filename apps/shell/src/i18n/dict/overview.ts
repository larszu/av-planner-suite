...
export const overview: Record<string, string> = {
  ...
  'overview.editor.crew.date': 'Date',
  'overview.editor.crew.end': 'End',
  'overview.editor.crew.booking': 'Booking',
  'overview.editor.crew.windowHint': 'With date, start and end the crew card checks overlaps of the same person. An end before the start falls on the next day.',
  ...
  // Crew on @avplan/crew-core (suite#260)
  'overview.crew.booking.pencil': 'pencilled',
  'overview.crew.booking.hold': 'on hold',
  'overview.crew.booking.confirmed': 'confirmed',
  'overview.crew.booking.worked': 'worked',
  'overview.crew.gap.name': 'name',
  'overview.crew.gap.date': 'date',
  'overview.crew.gap.start': 'start',
  'overview.crew.gap.end': 'end',
  'overview.card.crew.conflicts': '{n} overlap',
  'overview.card.crew.overlapWith': 'Overlaps with: {andere}',
  ...
  'overview.deckung.ampel.verfuegbar': 'from own stock',
  'overview.deckung.ampel.subhire': 'partly — sub-hire the rest',
  'overview.deckung.ampel.fehlt': 'not in stock',
  'overview.deckung.ampel.unbekannt': 'unknown',
  'overview.deckung.uncounted': 'not counted',
  'overview.deckung.noAnswer': 'no answer',
  'overview.deckung.stock': 'stock {n}',
  'overview.deckung.short': 'short {n}',
  'overview.deckung.badge.fehlt': 'missing {n}',
  'overview.deckung.badge.subhire': 'sub-hire {n}',
  'overview.deckung.badge.ok': 'covered',
  'overview.deckung.empty': 'The plan does not need any device yet.',
  'overview.deckung.noModel': '(no model)',
  'overview.deckung.stale': 'answer was for {n}',
  'overview.deckung.legend': 'Legend',
  'overview.deckung.askLager': 'Without an answer from inventory: {n}. It answers while it is open.',
  'overview.deckung.openLager': 'Open inventory',
  'overview.deckung.source': 'Demand from the plan, coverage from the inventory module',
}
