...
export const overview: Record<string, string> = {
  ...
  'overview.widget.rundown': 'Running order (imported)',
  ...
  // Bedarf 8 + 6 — der eingelesene Ablauf des Kunden.
  'overview.card.rundown.title': 'Running order (imported)',
  'overview.card.rundown.points': '{n} items',
  'overview.card.rundown.import': 'Import',
  'overview.card.rundown.empty':
    'No running order imported yet. It is not authored here \u2014 it comes from the spreadsheet it already lives in.',
  'overview.card.rundown.source': 'from {file}, imported {when}',
  ...
  'rundown.import.ignored': 'Not imported: {cols}',
  'rundown.import.cancel': 'Cancel',
  'rundown.import.confirm': 'Import',
  'rundown.field.cue': 'Cue',
  'rundown.field.title': 'Title',
  'rundown.field.start': 'Start',
  'rundown.field.duration': 'Duration',
  'rundown.field.note': 'Note',
