...
export const de: Record<string, string> = {
  ...
  'library.error.exists': 'Hersteller und Modell stehen schon in der Bibliothek. Stattdessen dort den vorhandenen Eintrag bestätigen.',
  'library.error.guidelines': 'Die Richtlinien der Bibliothek haben sich geändert. Die neue Fassung auf der Website annehmen und dann erneut versuchen.',
  'library.error.guidelinesLink': 'Richtlinien öffnen',
