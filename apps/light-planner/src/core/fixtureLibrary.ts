...
export const fixtureLibrary: Fixture[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: 'etc-s4-19', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Source-Four/', name: 'Source Four 19°', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-s4-26', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Source-Four/', name: 'Source Four 26°', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-s4-36', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Source-Four/', name: 'Source Four 36°', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-s4-50', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Source-Four/', name: 'Source Four 50°', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-s4-zoom-15-30', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Source-Four/', name: 'Source Four Zoom 15–30°', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-s4-zoom-25-50', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Source-Four/', name: 'Source Four Zoom 25–50°', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-s4led-s3', manufacturerUrl: 'https://www.etcconnect.com/Products/Lighting-Fixtures/Source-Four-LED-Series-3/Features.aspx', name: 'Source Four LED S3', manufacturer: 'ETC', category: 'profile',
  ...
  {
    id: 'etc-cs-fresnel', manufacturerUrl: 'https://www.etcconnect.com/Products/Lighting-Fixtures/ColorSource/Fixtures.aspx', name: 'ColorSource Fresnel', manufacturer: 'ETC', category: 'fresnel',
  ...
  {
    id: 'etc-cs-par', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/ColorSource-PAR/Features.aspx', name: 'ColorSource PAR', manufacturer: 'ETC', category: 'wash',
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: 'martin-mac-aura-xb', manufacturerUrl: 'https://www.martin.com/en-US/products/mac-aura-xb', name: 'MAC Aura XB', manufacturer: 'Martin / Harman', category: 'moving-wash',
  ...
  {
    id: 'robe-robin-600-ledwash', manufacturerUrl: 'https://www.robe.cz/ledwash-600', name: 'Robin 600 LEDWash', manufacturer: 'Robe', category: 'moving-wash',
  ...
  {
    id: 'robe-robin-ledbeam-150', manufacturerUrl: 'https://www.robe.cz/ledbeam-150', name: 'Robin LEDBeam 150', manufacturer: 'Robe', category: 'moving-wash',
  ...
  {
    id: 'chauvet-rogue-r2-wash', manufacturerUrl: 'https://chauvetprofessional.com/product/rogue-r2-wash/', name: 'Rogue R2 Wash', manufacturer: 'Chauvet Professional', category: 'moving-wash',
  ...
  {
    id: 'martin-mac-aura-pxl', manufacturerUrl: 'https://www.martin.com/en-US/products/mac-aura-pxl', name: 'MAC Aura PXL', manufacturer: 'Martin / Harman', category: 'moving-wash',
  ...
  {
    id: 'glp-impression-x4', manufacturerUrl: 'https://glp.de/en/products/entertainment-lighting/moving-lights/impression-x4-en', name: 'impression X4', manufacturer: 'GLP', category: 'moving-wash',
  ...
  {
    id: 'robe-robin-spiider', manufacturerUrl: 'https://www.robe.cz/spiider', name: 'Robin Spiider', manufacturer: 'Robe', category: 'moving-wash',
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: 'martin-mac-viper-profile', manufacturerUrl: 'https://www.martin.com/en-US/products/mac-viper-profile', name: 'MAC Viper Profile', manufacturer: 'Martin / Harman', category: 'moving-spot',
  ...
  {
    id: 'robe-robin-t1-profile', manufacturerUrl: 'https://www.robe.cz/t1-profile', name: 'Robin T1 Profile', manufacturer: 'Robe', category: 'moving-spot',
  ...
  {
    id: 'chauvet-maverick-mk3-profile', manufacturerUrl: 'https://chauvetprofessional.com/product/maverick-mk3-profile/', name: 'Maverick MK3 Profile', manufacturer: 'Chauvet Professional', category: 'moving-spot',
  ...
  { id: 'ayrton-ghibli', manufacturerUrl: 'https://www.ayrton.eu/produit/ghibli/', name: 'Ghibli', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [7, 56],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'ayrton-diablo', manufacturerUrl: 'https://www.ayrton.eu/produit/diablo/', name: 'Diablo', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [7, 53],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'ayrton-khamsin', manufacturerUrl: 'https://www.ayrton.eu/produit/khamsin/', name: 'Khamsin-S', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [7, 58],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'ayrton-domino-lt', manufacturerUrl: 'https://www.ayrton.eu/produit/domino-lt/', name: 'Domino LT', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [3.5, 53],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke', ipRating: 'IP65' },
  { id: 'ayrton-mistral', manufacturerUrl: 'https://www.ayrton.eu/produit/mistral/', name: 'Mistral', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [7, 53],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'ayrton-perseo-profile', manufacturerUrl: 'https://www.ayrton.eu/produit/perseo-profile/', name: 'Perseo Profile', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [7, 56],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke', ipRating: 'IP65' },
  { id: 'ayrton-karif-lt', manufacturerUrl: 'https://www.ayrton.eu/produit/karif-lt/', name: 'Karif LT', manufacturer: 'Ayrton', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [2.8, 47],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'ayrton-bora', manufacturerUrl: 'https://www.ayrton.eu/produit/bora/', name: 'Bora-S', manufacturer: 'Ayrton', category: 'moving-wash',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'etc-s4-led-s3-lustr', manufacturerUrl: 'https://www.etcconnect.com/Products/Lighting-Fixtures/Source-Four-LED-Series-3/Features.aspx', name: 'Source Four LED Series 3 Lustr X8', manufacturer: 'ETC', category: 'profile',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'interchangeable',
    colorTemp: 6800, cri: 90, weight: 42.5, mountType: 'clamp' },
  { id: 'etc-colorsource-spot', manufacturerUrl: 'https://www.etcconnect.com/workarea/DownloadAsset.aspx?id=10737484146', name: 'ColorSource Spot', manufacturer: 'ETC', category: 'profile',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'interchangeable',
    colorTemp: 6800, weight: 42.5, mountType: 'clamp' },
  { id: 'chauvet-maverick-storm-1-wash', manufacturerUrl: 'https://chauvetprofessional.com/product/maverick-storm-1-wash/', name: 'Maverick Storm 1 Wash', manufacturer: 'Chauvet Professional', category: 'moving-wash',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'robe-iforte-ltx', manufacturerUrl: 'https://www.robe.cz/products/iforte-ltx', name: 'iForte LTX', manufacturer: 'Robe', category: 'moving-spot',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'martin-mac-encore-perf-cld', name: 'MAC Encore Performance CLD', manufacturer: 'Martin / Harman', category: 'moving-spot',
    ...
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'martin-mac-aura-xip', manufacturerUrl: 'https://www.martin.com/en-US/products/mac-aura-xip', name: 'MAC Aura XIP', manufacturer: 'Martin / Harman', category: 'moving-wash',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'adj-vizi-beam-12rx', name: 'Vizi Beam 12RX', manufacturer: 'ADJ', category: 'moving-beam',
    ...
    beamShape: 'circular', beamRatioWH: 1, lensType: 'fixed',
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'astera-ax1-pixeltube', manufacturerUrl: 'https://astera-led.com/products/ax1-pixeltube/', name: 'AX1 PixelTube', manufacturer: 'Astera', category: 'cyc',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'chauvet-rogue-r2-spot', name: 'Rogue R2 Spot', manufacturer: 'Chauvet Professional', category: 'moving-spot',
    ...
    beamShape: 'circular', beamRatioWH: 1, lensType: 'fixed',
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'chauvet-colordash-par-h12x', manufacturerUrl: 'https://chauvetprofessional.com/product/colordash-par-h12x-ip/', name: 'COLORdash Par H12X IP', manufacturer: 'Chauvet Professional', category: 'par',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'fixed',
    colorTemp: 6800, colorTempRange: [2800, 10000], weight: 42.5, mountType: 'clamp', ipRating: 'IP65' },
  { id: 'robe-ledbeam-350', manufacturerUrl: 'https://www.robe.cz/ledbeam-350', name: 'LEDBeam 350', manufacturer: 'Robe', category: 'moving-wash',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [4, 50],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'elation-kl-panel-xl', manufacturerUrl: 'https://elationlighting.com/kl-panel-xl', name: 'KL Panel XL', manufacturer: 'Elation', category: 'led-panel',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'adj-focus-spot-6z', name: 'Focus Spot 6Z', manufacturer: 'ADJ', category: 'moving-spot',
    ...
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'chauvet-rogue-r1-beamwash', manufacturerUrl: 'https://chauvetprofessional.com/product/rogue-r1-beamwash/', name: 'Rogue R1 BeamWash', manufacturer: 'Chauvet Professional', category: 'moving-wash',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  { id: 'cameo-opus-s5', name: 'OPUS S5', manufacturer: 'Cameo', category: 'moving-spot',
    ...
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [6, 46],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'cameo-opus-h5', manufacturerUrl: 'https://www.cameolight.com/en/solutions/rental/moving-lights/beam-moving-heads/20662/opus-h5', name: 'OPUS H5', manufacturer: 'Cameo', category: 'moving-beam',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [2, 42],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke' },
  { id: 'cameo-otos-h5', manufacturerUrl: 'https://www.cameolight.com/en/series/otos-series/26039/otos-h5', name: 'OTOS H5', manufacturer: 'Cameo', category: 'moving-beam',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [2, 42],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke', ipRating: 'IP65' },
  ...
  { id: 'cameo-otos-b5', manufacturerUrl: 'https://www.cameolight.com/en/solutions/rental/moving-lights/beam-moving-heads/29085/otos-b5', name: 'OTOS B5', manufacturer: 'Cameo', category: 'moving-beam',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
    beamShape: 'circular', beamRatioWH: 1, lensType: 'zoom', zoomRange: [2, 24],
    colorTemp: 6800, weight: 42.5, mountType: 'yoke', ipRating: 'IP65' },
  { id: 'cameo-movo-beam-z100', manufacturerUrl: 'https://www.cameolight.com/en/solutions/dj-musicians/moving-lights/moving-heads/17232/movo-beam-z100', name: 'MOVO BEAM Z100', manufacturer: 'Cameo', category: 'moving-beam',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: 'robe-robin-megapointe', manufacturerUrl: 'https://www.robe.cz/megapointe', name: 'Robin MegaPointe', manufacturer: 'Robe', category: 'moving-beam',
    wattage: 307, lumens: 8200, beamAngle: 10, fieldAngle: 10,
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: 'etc-cs-cyc', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/ColorSource-CYC/Features.aspx', name: 'ColorSource CYC', manufacturer: 'ETC', category: 'cyc',
  ...
  {
    id: 'etc-desire-d40', manufacturerUrl: 'https://www.etcconnect.com/Products/Entertainment-Fixtures/Desire-D40/Features.aspx', name: 'Desire D40', manufacturer: 'ETC', category: 'flood',
  ...
  // ═══════════════════════════════════════════════════════════
  {
    id: 'aputure-ls-600x-pro', manufacturerUrl: 'https://aputure.com/en-US/products/ls-600x-pro', name: 'LS 600x Pro', manufacturer: 'Aputure', category: 'led-panel',
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    id: 'elation-kl-fresnel-8-fc', manufacturerUrl: 'https://www.elationlighting.com/products/kl-fresnel-8-fc', name: 'KL Fresnel 8 FC', manufacturer: 'Elation', category: 'fresnel',
  ...
  {
    id: 'elation-kl-profile-fc', manufacturerUrl: 'https://www.elationlighting.com/products/kl-profile-fc', name: 'KL Profile FC', manufacturer: 'Elation', category: 'profile',
  ...
  {
    id: 'elation-kl-par-fc', manufacturerUrl: 'https://www.elationlighting.com/products/kl-par-fc', name: 'KL PAR FC', manufacturer: 'Elation', category: 'par',
  ...
  {
    id: 'elation-fuze-wash-z350', manufacturerUrl: 'https://www.elationlighting.com/products/fuze-wash-z350', name: 'Fuze Wash Z350', manufacturer: 'Elation', category: 'moving-wash',
  ...
  {
    id: 'elation-fuze-par-z120', manufacturerUrl: 'https://www.elationlighting.com/fuze-par-z120-ip', name: 'Fuze Par Z120 IP', manufacturer: 'Elation', category: 'moving-wash',
