 ...
 * an `t('dlg.sch.cbl.basis', …)` gereicht. Dass er eine Konstante ist und
 * kein Literal, hat ihn beim Sprachwechsel fast uebersehen lassen: das
 * Tausch-Werkzeug sieht nur Zeichenketten-Literale in `t()`-Aufrufen.
 * Gefunden hat ihn `i18n:check` ueber die andere Seite — der Schluessel war
 * erreichbar und hatte keine deutsche Fassung.
 */
