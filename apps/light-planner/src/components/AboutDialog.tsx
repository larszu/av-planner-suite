  ...
  <div className="modal-backdrop" onClick={onClose}>
    <div className="modal about-modal" onClick={(e) => e.stopPropagation()}>
      ...
      <p className="about-desc">
        {t('dlg.about.desc', 'Planning of event and stage lighting – floor-plan import, scale, fixtures with real photometric data, heatmap, 3D preview with photo view, scenes, layers, DMX patch & export.')}
      </p>
      <div className="about-tech">React · TypeScript · Three.js · Vite</div>
      <div className="about-copy">© {new Date().getFullYear()} · {t('dlg.about.copy', 'All calculations remain traceable.')}</div>
