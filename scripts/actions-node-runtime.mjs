...
// mehr. Gemessen 2026-09-05 lief hier fast alles auf node20: `ci.yml` stand
// komplett auf `checkout@v4`/`setup-node@v4`, `release-suite.yml` auf
// `upload-artifact@v4`, `download-artifact@v4` und `action-gh-release@v2`.
// Inzwischen haben ALLE verwendeten Actions ein node24-Major; die Suite hing
// bis zu drei Majors zurueck.
//
...
//
// Und er prueft NUR `.github/workflows/` dieses Repos. Die vendorten Kopien
// unter `apps/*/.github/workflows/` sind im Monorepo inert -- sie laufen
// nirgends, und sie hier mitzuzaehlen wuerde eine Zusicherung vortaeuschen,
// die es nicht gibt. Fuer die gilt der Guard des jeweiligen Upstream-Repos.
//
